...
function Numbers() {
  return (
    <div className=" h-auto bg-dark flex flex-col justify-center items-center text-center gap-10 py-[120px] sm:flex-row flex-wrap md:flex-row  lg:flex-row xl:flex-row 2xl:flex-row">
