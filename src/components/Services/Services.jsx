...
function Service() {
  return (
    <div className=" bg-bright flex flex-col   h-full text-center overflow-hidden  py-10 ">
      <h3 className="mt-[60px] text-4xl font-bold text-[#0085FF]">My Experience</h3>
      <div className="flex flex-col md:flex-row justify-center items-center mt-[100px]  gap-x-[50px] gap-y-[50px]">
        <div className="w-[250px] flex flex-col justify-center items-center ">
          ...
          <p className='font-medium text-[16px] mt-3'>is responsible for connecting the hospital's database system with Gateway to send expense information to the "Pao Tang" app.</p>
        </div>
        <div className="w-[250px] flex flex-col justify-center items-center ">
          <FaPaintbrush className="w-[80px] h-[80px] text-[#0085FF]" />
          <h4 className="text-[#0085FF] text-2xl font-bold mt-[25px]">Design UI</h4>
          <p className='font-medium text-[16px] mt-3'>Use Figma to design mockups in projects received while working, such as Police 4.0 , another </p>
        </div>
        <div className="w-[250px] flex flex-col justify-center items-center ">
          ...
          <p className='font-medium text-[16px] mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni recusandae enim consectetur sapiente necessitatibus neque eos ipsa ullam minima nulla.</p>
        </div>
      </div>
    </div>
  );
